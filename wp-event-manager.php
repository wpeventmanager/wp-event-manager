...
class WP_Event_Manager extends WPEM_Updater {
	 ...
	 * @since  3.1.33
	 */
	private static $wpem_verion = '3.3.0';
	...
	public function frontend_scripts() {
		...
		wp_register_style('wp-event-manager-lightpick-datepicker-style', EVENT_MANAGER_PLUGIN_URL . '/assets/js/lightpick-datepicker/lightpick.css', array(), EVENT_MANAGER_VERSION, true);
		...
		wp_register_style('wp-event-manager-jquery-ui-daterangepicker', EVENT_MANAGER_PLUGIN_URL . '/assets/js/jquery-ui-daterangepicker/jquery.comiseo.daterangepicker.css', array(), EVENT_MANAGER_VERSION, true);
		wp_register_style('wp-event-manager-jquery-ui-daterangepicker-style', EVENT_MANAGER_PLUGIN_URL . '/assets/js/jquery-ui-daterangepicker/styles.css', array(), EVENT_MANAGER_VERSION, true);
		...
		wp_register_style('wp-event-manager-slick-style', EVENT_MANAGER_PLUGIN_URL . '/assets/js/slick/slick.css' , array(), EVENT_MANAGER_VERSION, true);
		
		wp_register_style('wp-event-manager-grid-style', EVENT_MANAGER_PLUGIN_URL . '/assets/css/wpem-grid.min.css', array(), EVENT_MANAGER_VERSION, true);
		wp_register_style('wp-event-manager-font-style', EVENT_MANAGER_PLUGIN_URL . '/assets/fonts/style.css', array(), EVENT_MANAGER_VERSION, true);
