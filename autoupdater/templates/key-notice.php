<div class="notice notice-error">
	...
	<p><small class="description"><?php printf(__('Lost your key? <a href="%s">Retrieve it here</a>.', 'wp-event-manager'), esc_url( 'https://wp-eventmanager.com/lost-license-key/' ) ); ?></small></p>
</div>