...
function get_event_start_date( $post = null ) {
	...
	$event_start_date 	= date( $date_format, strtotime( $event_start_date ) );
...
function get_event_start_time( $post = null ) {
	...
	if( $event_timezone )
		$event_start_time = $post->_event_start_time.' (' . $event_timezone.')';
	else
		$event_start_time = $post->_event_start_time;
...
function get_event_end_date( $post = null ) {
	...
	$date_format = WP_Event_Manager_Date_Time::get_event_manager_view_date_format();
	$event_end_date = date( $date_format, strtotime( $event_end_date ) );
...
function get_event_end_time( $post = null ) {
	...
	if( $event_timezone )
		$event_end_time = $post->_event_start_time.' (' . $event_timezone.')';
	else
		$event_end_time = $post->_event_start_time;
