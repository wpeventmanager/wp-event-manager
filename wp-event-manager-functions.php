...
{
	check_ajax_referer('event_manager_nonce', 'nonce'); // Add nonce security check if needed

	$page = $_POST['page'];

	// Modify your WP_Query to load additional events based on the $page variable
	$args = array(
		'post_type'           => 'event_listing',
		'post_status'         => array('publish', 'expired', 'pending'),
		'ignore_sticky_posts' => 1,
		'posts_per_page'      => 10, // Adjust as needed
		'offset'              => ($page - 1) * 10, // Adjust as needed
		'orderby'             => 'date',
		'order'               => 'desc',
	...
	// Output the loaded events (use the same template as before)
	get_event_manager_template('event-dashboard.php', array(
