...
class WP_Event_Manager_Setup {
	...
	public function output() {
		...
		if(3 === $step && !empty($_POST)) {
			...
			$raw_create_pages = isset($_POST['wp-event-manager-create-page']) ? map_deep( wp_unslash($_POST['wp-event-manager-create-page']), 'wp_kses_post') : array();
			$raw_page_titles = isset($_POST['wp-event-manager-page-title']) ? map_deep( wp_unslash($_POST['wp-event-manager-page-title']), 'wp_kses_post') : array();
