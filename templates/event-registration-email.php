...
<p>
	...
	printf(
		wp_kses_post(
			__( 
				'To register for this event <strong>email your details to</strong> <a class="event_registration_email" href="mailto:%1$s%2$s">%1$s</a>',
				'wp-event-manager'
			)
		),
		esc_attr( $register->email ),
		esc_attr( '?subject=' . rawurlencode( $register->subject ) )
	); ?>
</p>
