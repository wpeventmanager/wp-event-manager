...
$twelve_hour =  array( '0:00 AM',  '0:30  AM', '1:00 AM', '1:30 AM','2:00 AM', '2:30 AM', '3:00 AM', '3:30 AM', '4:00 AM', '4:30 AM', '5:00 AM', '5:30 AM', '6:00 AM', '6:30 AM', '7:00 AM', '7:30 AM', '8:00 AM', '8:30 AM', '9:00 AM', '9:30 AM', '10:00 AM', '10:30 AM', '11:00 AM', '11:30 AM','12:00 AM', '12:30 AM','0:00 PM',  '0:30  PM', '1:00 PM', '1:30 PM','2:00 PM', '2:30 PM', '3:00 AM', '3:30 PM', '4:00 PM', '4:30 PM', '5:00 PM', '5:30 PM', '6:00 PM', '6:30 PM', '07:00 PM', '07:30 PM', '08:00 PM', '08:30 PM', '09:00 PM', '09:30 PM', '10:00 PM', '10:30 PM', '11:00 PM', '11:30 PM','12:00 PM', '12:30 PM' );
...
<select name="<?php echo esc_attr( isset( $field['name'] ) ? $field['name'] : $key ); ?>" id="<?php echo esc_attr( $key ); ?>" <?php if ( ! empty( $field['required'] ) ) echo 'required'; ?> attribute="<?php echo esc_attr( isset( $field['attribute'] ) ? $field['attribute'] : '' ); ?>" >
	...
	<?php foreach ($twelve_hour as $key => $value) { ?> 
		<option value="<?php echo esc_attr( $key ); ?>" <?php if ( isset( $field['value'] ) ) selected( isset( $field['value'] ) ? $field['value'] :  $value ); ?>><?php echo esc_html( $value ); ?></option>
	<?php } ?>
</select>
