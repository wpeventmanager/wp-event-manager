 ...
 */
?>
<input type="email" class="input-text <?php echo esc_attr(isset($wpem_field['class']) ? $wpem_field['class'] : $wpem_key); ?>" name="<?php echo esc_attr(isset($wpem_field['name']) ? $wpem_field['name'] : $wpem_key); ?>" id="<?php echo isset($wpem_field['id']) ? esc_attr($wpem_field['id']) :  esc_attr($wpem_key); ?>" placeholder="<?php echo empty($wpem_field['placeholder']) ? '' : esc_attr($wpem_field['placeholder']); ?>" attribute="<?php echo esc_attr(isset($wpem_field['attribute']) ? $wpem_field['attribute'] : ''); ?>" value="<?php echo isset($wpem_field['value']) ? esc_attr($wpem_field['value']) : ''; ?>" maxlength="<?php echo !empty($wpem_field['maxlength']) ? esc_attr($wpem_field['maxlength']) : ''; ?>" <?php if (!empty($wpem_field['required'])) echo esc_attr('required'); ?> <?php if (isset($wpem_field['disabled']) && !empty($wpem_field['disabled'])) echo esc_attr('disabled'); ?> />
