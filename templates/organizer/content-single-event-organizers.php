                ...
                <div class="wpem-organizer-profile-wrapper" id="wpem_organizer_profile">
                    ...
                    <div class="wpem-organizer-wrapper wpem-listing-accordion-panel active" style="display: block;">
                        <div class="wpem-organizer-profile">
                            ...
                            $wpem_organizer_ids = wpem_get_event_organizer_ids($event_id);
                                                ...
                                                <div class="wpem-col-md-3">
                                                    <div class="wpem-organizer-logo-wrapper">
                                                        <div class="wpem-organizer-logo">
                                                            <a><?php wpem_display_organizer_logo('', '', $wpem_organizer); ?></a>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="wpem-col-md-9 wpem-col-sm-12">
                                                    <div class="wpem-organizer-infomation-wrapper">
                                                        ...
                                                        <div class="wpem-organizer-name wpem-heading-text">
                                                            <span><?php echo esc_attr($wpem_organizer->post_title); ?></span>
                                                        </div>
                                                        ...
                                                        if (isset($wpem_organizer_custom_fields)) {
                                                            foreach ($wpem_organizer_custom_fields as $wpem_key => $wpem_field) : ?>
                                                                <?php if (!strstr($wpem_key, 'organizer') && !strstr($wpem_key, 'vcv') && !strstr($wpem_key, 'submitting') && !empty(get_post_meta($wpem_organizer_id, '_' . $wpem_key))) : ?>
                                    ...
                                    <div class="wpem-col-md-9 wpem-col-sm-12">
                                        ...
                                        <div class="wpem-organizer-social-links">
                                            <div class="wpem-organizer-social-lists">
                                                ...
                                                $wpem_organizer_website  = wpem_get_organizer_website($event_id);
                                                $wpem_organizer_facebook = wpem_get_organizer_facebook($event_id);
                                                $wpem_organizer_instagram = wpem_get_organizer_instagram($event_id);
                                                $wpem_organizer_twitter  = wpem_get_organizer_twitter($event_id);
                                                $wpem_organizer_youtube  = wpem_get_organizer_youtube($event_id);
