...
<div class="wpem-form-group">
	...
	<div class="field account-sign-in">			<?php				$user = wp_get_current_user();				printf( wp_kses( __( 'You are currently signed in as <strong>%s</strong>.', 'wp-event-manager' ), array(  'strong' => array() ) ), $user->user_login );    		?>			<a
			class="wpem-theme-button"
...
<div class="wpem-form-group">
	...
	<div class="field account-sign-in">
		<a class="wpem-theme-button" href="<?php echo !empty(get_option('event_manager_login_page_url')) ? apply_filters( 'submit_event_form_login_url', get_option('event_manager_login_page_url') ) : 	home_url().'/wp-login.php'; ?>"><?php _e( 'Sign in', 'wp-event-manager' ); ?></a>			
