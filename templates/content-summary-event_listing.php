	...
	<div <?php event_listing_class(''); ?>>
		<a href="<?php the_permalink(); ?>" class="wpem-event-action-url event-widget">
			<div class="wpem-event-banner">
				<div class="wpem-event-banner-img"><?php wpem_display_event_banner(); ?></div>
			</div>
				...
				<div class="wpem-event-details">
					...
					<div class="wpem-event-location">
						<span class="wpem-event-location-text">
							<?php if(wpem_get_event_location()=='Online Event'): esc_html_e('Online Event','wp-event-manager'); else:  wpem_display_event_location(false); endif; ?>
						</span>
					</div>                        
				    <div class="wpem-event-type"><?php wpem_display_event_type(); ?></div>

				    <?php if (wpem_get_event_ticket_option()) : ?>
