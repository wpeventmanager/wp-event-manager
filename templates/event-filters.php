	...
	<?php do_action( 'event_manager_event_filters_search_events_start', $atts ); ?>
		<div class="wpem-search-event">
			<div class="wpem-search-event-flex">
				...
				<div class="wpem-search-event-more-filter"><a href="javascript:void(0);" class="wpem-search-event-more-filter-link"><i class="wpem-icon-filter wpem-mr-2"></i> Show Filters</a></div>
			</div>
		</div>
