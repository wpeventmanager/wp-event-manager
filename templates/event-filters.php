...
<form class="wpem-main wpem-form-wrapper wpem-event-filter-wrapper event_filters" id="event_filters">
	...
	<?php do_action( 'event_manager_event_filters_search_events_start', $atts ); ?>
		<div class="wpem-search-event">
			<div class="wpem-search-event-flex">
				<div class="wpem-form-group">
					<i class="wpem-icon-search"></i>
					<input type="text" autocomplete="off" name="search_keywords" id="search_keywords" placeholder="<?php esc_attr_e( 'Keywords', 'wp-event-manager' ); ?>" value="<?php echo esc_attr( $keywords ); ?>" />
				</div>
				...
				<div class="wpem-search-event-more-filter"><a href="#" class="wpem-search-event-more-filter-link"><i class="wpem-icon-filter wpem-mr-2"></i> Show Filters</a></div>
			</div>
		</div>
		...
		<div class="wpem-row">
			<div class="wpem-col-sm-4">
				<div class="wpem-form-group">
					<input type="text" id="demo-2" placeholder="Select Date Range">
				</div>
			</div>
			...
			<?php if ( $datetimes) : ?>	
				...
				<div class="wpem-col wpem-d-none">
					<div class="wpem-form-group">
		...
		<div class="wpem-row wpem-d-none">
