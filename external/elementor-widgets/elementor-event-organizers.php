...
class Elementor_Event_Organizers extends Widget_Base {
	...
	protected function render() {
		...
		echo wp_kses_post(do_shortcode('[event_organizers order="'.esc_attr($settings['order']).'" orderby="'.esc_attr($settings['orderby']).'" show_thumb="'.esc_attr($settings['show_thumb']).'" show_count="'.esc_attr($settings['show_count']).'"]'));
	}
